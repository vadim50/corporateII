...
<li id="li-comment-{{ $item->id }}" class="comment even
    {{ $item->user_id == $article->user_id ? 'bypostauthor odd' : '' }}">
    <div id="comment-{{ $item->id }}" class="comment-container">
        <div class="comment-author vcard">
            ...
            <cite class="fn">
    {{ isset($item->name) ? ($item->name) : ($item->article->user->name) }}
</cite>                 
        </div>
        ...
        <div class="comment-meta commentmetadata">
            ...
            <div class="reply group">
                ...
                onclick="return addComment.moveForm(&quot;comment-{{$item->id}}&quot;, &quot;{{$item->id}}&quot;, &quot;respond&quot;, &quot;{{$item->article->id}}&quot;)">Reply</a>                  
            </div>
            <!-- .reply -->
        </div>
